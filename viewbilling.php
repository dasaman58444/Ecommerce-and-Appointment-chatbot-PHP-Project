...
?>
 	<table width="80%" border="3">
      <tbody>
        ...
        <tr>
          <th width="50%" scope="col"><div align="right">Appointment Number &nbsp; </div></th>
          	<td width="30%"> <?php echo $rsbilling_records[appointmentid]; ?>
            </td>
        </tr>
    ...
    <br><br>
	<table class="order-table" width="80%" border="3">
      <thead>
       <tr>
          <th width="20%" scope="col">Date</th>
          <th width="50%" scope="col">Decription</th>
          <th width="20%" scope="col">Bill Amount</th>
        </tr>
        </thead>
        <tbody>
         <?php
...
if($rs[bill_type]  == "Prescription charge")
{
    ...
    <table width="50%" border="3">
      <tbody>
        ...
        <tr>
          <th width="70%" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
          	<td width="30%">&nbsp;Rs. <?php echo $taxamt = 5 * ($billamt / 100); ?>
            </td>
        </tr>
