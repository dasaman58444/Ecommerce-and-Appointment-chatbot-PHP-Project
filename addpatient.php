...
<section id="page-header" style="margin-top:100px;">
    <div class="row text-center">
        ...
        <div class="col-md-4">
            <h2 class="h2w">Patient profile Registration Panel</h2>
        </div>
    ...
    <form method="post" action="" name="frmpatient" onSubmit="return validateform()">
      ...
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" style="width:100%" name="patientname" id="patientname"  value="<?php echo $rsedit[patientname]; ?>"/></td>
        </tr>
<?php
if(isset($_GET[editid]))
{
...
?>
        ...
        <tr>
          <td>Mobile Number</td>
            <td><input type="text" name="mobilenumber" style="width:100%" id="mobilenumber" value="<?php echo $rsedit[mobileno]; ?>" /></td>
        </tr>
        <tr>
          <td>City</td>
            <td><input type="text" name="city" style="width:100%" id="city" value="<?php echo $rsedit[city]; ?>" /></td>
        </tr>
        <tr>
          <td>PIN Code</td>
            <td><input type="text" name="pincode" style="width:100%" id="pincode" value="<?php echo $rsedit[pincode]; ?>" /></td>
        </tr>
        <tr>
          <td>Login ID</td>
            <td><input type="text" name="loginid" style="width:100%" id="loginid"  value="<?php echo $rsedit[loginid]; ?>"/></td>
        </tr>
        <tr>
          <td>Password</td>
            <td><input type="password" style="width:100%" name="password" id="password" value="<?php echo $rsedit[password]; ?>" /></td>
        </tr>
        <tr>
          <td>Confirm Password</td>
            <td><input type="password" style="width:100%" name="confirmpassword" id="confirmpassword"  value="<?php echo $rsedit[confirmpassword]; ?>"/></td>
        </tr>
        <tr>
          <td>Blood Group</td>
