...
<section id="page-header" style="margin-top:100px;">
    <div class="row text-center">
        ...
        <div class="col-md-4">
            <h2 class="h2w">Add Treatment Record</h2>
        </div>
...
?>			
        ...
        <tr>
         <td></td>
          <td><br><input type="submit" class="btn btn-outline-success" name="submit" id="submit" value="Submit" /> | <a href='patientreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appid]; ?>'><strong>View Patient Report>></strong></a></td>
        </tr>
      </tbody>
    </table>
    </form>
    ...
    <table class="order-table" style="width:80%;text-align:center;margin-bottom:100px;">
        ...
        echo "<tr>
          <td>&nbsp;$rstreatment[treatmenttype]</td>
			...
			<td>&nbsp;<a href='treatmentfiles/$rs[uploads]' target='_blank'>Download</a></td>
