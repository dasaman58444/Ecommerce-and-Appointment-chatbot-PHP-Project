      ...
      <tbody>
        <tr>
          <td style="width:30%";>Patient Name</td>
            <td style="width:70%";><input type="text" name="patientname" id="patientname"  value="<?php echo $rsedit[patientname]; ?>"/></td>
        </tr>
        <tr>
        ...
        <tr>
             <td></td>
            <td><br><input type="submit" name="submit" id="submit" value="Edit" />
          </td>
        </tr>
      </tbody>
    </table>
