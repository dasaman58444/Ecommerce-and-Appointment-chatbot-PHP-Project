...
if(isset($_POST[submit]))
{
	...
	$sql = "SELECT * FROM doctor WHERE loginid='$_POST[loginid]' AND password='$password' AND status='Active'";
...
<section id="login_page">
   ...
   <form method="post" action="" name="frmdoctlogin" onSubmit="return validateform()">
       <table style="width:100%;color:white;font-size:25px;">
      <tbody>
        <tr>
        ...
        <tr>
         <td></td>
          <td><br><input class="btn btn-primary" type="submit" name="submit" id="submit" value="Login" /></td>
        </tr>
      </tbody>
    </table>
    </form>
